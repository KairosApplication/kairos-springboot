...
- Mudanças comportamentais precisam de testes de regressão, incluindo entradas inválidas e erros. Os testes usam H2 por padrão; `-Ppostgres-tests` executa a suíte com PostgreSQL isolado via Testcontainers e requer Docker. Nunca devem acessar Aiven.
